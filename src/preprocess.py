...
Includes all preprocessing functionality for West Nile Virus data.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Preprocess West Nile Virus data')
    ...
    preprocessor = WestNileDataPreprocessor(data_dir=args.data_dir)
    X_train, X_test, y_train = preprocessor.process_all_data()

    # Save processed data
    preprocessor.save_processed_data(X_train, X_test, y_train, output_dir=args.output_dir)
